...
const cases = [
  ...
  { id: "participant-latest-finish-end-time", expectedSolverStatus: "INFEASIBLE", expectedTsLegal: false, probeCandidate: [{ sessionId: "session-a", day: "Monday", startTime: "20:00", endTime: "20:45", teacherId: "teacher-a", roomId: "room" }, { sessionId: "session-b", day: "Wednesday", startTime: "16:00", endTime: "17:00", teacherId: "teacher-a", roomId: "room" }, { sessionId: "session-c", day: "Tuesday", startTime: "16:00", endTime: "17:00", teacherId: "teacher-a", roomId: "room" }], problem: problem([{ id: "latest", kind: "LATEST_FINISH_BY_PARTICIPANT", ruleIds: ["LATEST"], selector: { participantIds: ["student-a"] }, parameters: { latestFinish: "20:30" }, explanation: "latest" }, fixed("fa", "Class A", "Monday", "20:00", "20:45"), fixed("fb", "Class B", "Wednesday", "16:00", "17:00"), fixed("fc", "Class C", "Tuesday", "16:00", "17:00")]) },
] as const;
...
parityDescribe("POL-03/SET-06 shared typed runtime parity", () => {
  it("agrees for all promoted participant and relationship families", () => {
