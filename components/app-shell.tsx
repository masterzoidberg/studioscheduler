...
import { AlertTriangle, CalendarDays, Home, LogOut, Menu, MoreHorizontal, RefreshCw, Settings, SlidersHorizontal, X } from "lucide-react";
...
export function AppShell({ children }: { children: ReactNode }) {
  const pathname = usePathname();
  const { loading,error,accessMode,session,role,state,scheduleIsStale,validation,refresh,signOut } = useWorkspace();
