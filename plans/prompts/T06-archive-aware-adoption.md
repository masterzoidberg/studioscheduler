...
Task prerequisites: T02, T04. If any prerequisite lacks verified DONE evidence, record the issue and do not bypass it. TASKS.md is the status authority; prompts are scope/acceptance references.

## Exact scope

The solver excludes archived sessions but adoption counts all studio sessions.

Deliver only T06, using the current architecture. 
