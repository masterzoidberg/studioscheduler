...
Task prerequisites: T22. If any prerequisite lacks verified DONE evidence, record the issue and do not bypass it. TASKS.md is the status authority; prompts are scope/acceptance references.

## Exact scope

Storage contains studios but the application and routes hard-code DWDE.

Deliver only T23, using the current architecture. 
