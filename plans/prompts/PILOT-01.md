# PILOT-01 — Accept a supported external commercial pilot

Execution class: **STANDARD IMPLEMENTATION**. Milestone: **C**. Dependencies: **CAND-01, OPS-03**.
Status is owned by [TASKS](../TASKS.md); do not infer readiness from this prompt existing.

## Outcome and current state

Run representative pilot for two complete weekly planning/revision cycles with named responsible support operator, documented limits, authorized environment and privacy terms supplied by owner. Track failures, assistance, solve latency and unresolved issues.

Current evidence at audit HEAD `9120439`: Independent technical onboarding does not establish external operating/support readiness. For later tasks, predecessor behavior above is an expected contract, not a claim that it exists in this baseline.
...
No charging, contacting people, contract drafting or automatic deployment authority.

## Tests and acceptance criteria

- All C milestone criteria met, no unresolved data loss/authorization/HARD legality defect, operator responds to a simulated incident; participant confirms usable output and support route
- Record commercial arrangement externally if applicable.
