...
**Current milestone: A — DWDE Operational. Sole selected next run: R5 / OPS-01 — verify deployment configuration and recovery. Execution class: STANDARD IMPLEMENTATION.** Read [NEXT](NEXT.md) and [the selected prompt](prompts/OPS-01.md). POL-02 through POL-04, SET-03 through SET-07, UX-01 through UX-03 and LOCK-01 are DONE with their criterion-level evidence and limitations recorded in [TASKS](TASKS.md). GEN-01 remains queued for the later B route.
