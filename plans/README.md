...
**Current milestone: A — DWDE Operational. Sole selected next run: R4 / UX-03 — deliver usable schedule print/export and responsive review. Execution class: STANDARD IMPLEMENTATION.** Read [NEXT](NEXT.md) and [the selected prompt](prompts/UX-03.md). POL-02 through POL-04, SET-03 through SET-07, UX-01, UX-02 and LOCK-01 are DONE with their criterion-level evidence and limitations recorded in [TASKS](TASKS.md).
