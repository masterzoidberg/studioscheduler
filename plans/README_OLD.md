...
| File | Purpose |
|---|---|
| [MASTER_PLAN](MASTER_PLAN_OLD.md) | Product objective, architecture, findings, milestones, critical paths, risks |
| [TASKS](TASKS_OLD.md) | Authoritative status, dependencies, task scope, acceptance, verification, evidence |
| [NEXT](NEXT_OLD.md) | Immediate T01–T10 execution queue |
| [DWDE_RELEASE_PLAN](DWDE_RELEASE_PLAN_OLD.md) | DWDE release blockers and manager acceptance |
| [GENERIC_PRODUCT_PLAN](GENERIC_PRODUCT_PLAN_OLD.md) | Tenant extraction and productization |
| [STUDIO_2_ACCEPTANCE](STUDIO_2_ACCEPTANCE.md) | Formal independent-studio acceptance specification |
| [ARCHITECTURE_CUTOVER](ARCHITECTURE_CUTOVER_OLD.md) | Migration from split to shared scheduling authority |
...
| [DECISIONS](DECISIONS_OLD.md) | Active decisions and evidenced deviations |
...
T01 through T08 are accepted. T02's initial Docker blocker was resolved and recorded as historical evidence in [TASKS](TASKS_OLD.md). Upcoming prerequisites requiring verification:
