...
Read [README](README_OLD.md), [MASTER_PLAN](MASTER_PLAN_OLD.md), and [execution rules](CODEX_EXECUTION_RULES.md) first. Select the first executable unfinished task in numeric order; dependencies are minimum prerequisites, not permission to skip earlier ready P0 work.
...
[Open T01 prompt](prompts/archive/T01-line-ending-integrity.md)
...
[Open T02 prompt](prompts/archive/T02-database-integration-harness.md)
...
[Open T03 prompt](prompts/archive/T03-constraint-model-canonicalization.md)
...
[Open T04 prompt](prompts/archive/T04-canonical-candidate-intervals.md)
...
[Open T05 prompt](prompts/archive/T05-unsupported-dwde-policy-guard.md)
...
[Open T06 prompt](prompts/archive/T06-archive-aware-adoption.md)
...
[Open T07 prompt](prompts/archive/T07-coherent-solver-snapshots.md)
...
[Open T08 prompt](prompts/archive/T08-candidate-stale-schedule-binding.md)
...
[Open T09 prompt](prompts/archive/T09-session-specific-locks.md)
...
[Open T10 prompt](prompts/archive/T10-manual-move-authoritative-ir.md)
...
[Open T11 prompt](prompts/archive/T11-assign-unassign-authority.md)
...
[Open T12 prompt](prompts/archive/T12-rebase-undo-authority.md)
...
[Open T13 prompt](prompts/archive/T13-close-legacy-write-bypasses.md)
...
[Open T14 prompt](prompts/T14-dwde-acceptance-fixture_OLD.md)
...
[Open T15 prompt](prompts/T15-bounded-solve-diagnostics_OLD.md)
...
[Open T16 prompt](prompts/T16-manager-workflow-export_OLD.md)
...
[Open T17 prompt](prompts/T17-preference-scoring_OLD.md)
...
[Open T18 prompt](prompts/T18-soft-optimization_OLD.md)
...
[Open T19 prompt](prompts/T19-candidate-comparison-persistence_OLD.md)
...
[Open T20 prompt](prompts/T20-typed-id-targets_OLD.md)
...
[Open T21 prompt](prompts/T21-dwde-tenant-policy_OLD.md)
...
[Open T22 prompt](prompts/T22-tenant-explicit-commands_OLD.md)
...
[Open T23 prompt](prompts/T23-tenant-initialization-selection_OLD.md)
...
[Open T24 prompt](prompts/T24-tenant-operational-ui_OLD.md)
...
[Open T25 prompt](prompts/T25-structured-rule-authoring_OLD.md)
...
[Open T26 prompt](prompts/T26-csv-intake_OLD.md)
...
[Open T27 prompt](prompts/T27-studio-2-acceptance_OLD.md)
...
[Open T28 prompt](prompts/T28-ai-canonical-context_OLD.md)
...
- [vercel.json](../vercel.json)
- [.env.example](../.env.example)
- [plans/DWDE_RELEASE_PLAN.md](../plans/DWDE_RELEASE_PLAN_OLD.md)
...
[Open T29 prompt](prompts/T29-paid-pilot-operations_OLD.md)
